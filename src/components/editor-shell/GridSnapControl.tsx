...
/**
 * Grid snapping for the tools panel.
 *
 * This is `SnapControl` without its infinite-viewport toggle: the viewport is
 * always infinite now, so there is nothing left to switch. Terrain is authored
 * at kilometre scale and a bounded construction grid only ever got in the way.
 */
