...
const BASE_R0_FAR = 26;
const BASE_BAND0 = 5;
const BASE_R1_FAR = 150;
const BASE_BAND1 = 14;
const BASE_R2_FAR = 460;
const BASE_BAND2 = 36;
const BASE_EX_R1_FAR = 120;
const BASE_EX_BAND = 15;
...
export class Forests {
  ...
  init(renderer: Renderer): void {
    void renderer;
    const R0_FAR = BASE_R0_FAR * this.lodScale;
    const BAND0 = BASE_BAND0 * this.lodScale;
    const R1_FAR = BASE_R1_FAR * this.lodScale;
    const BAND1 = BASE_BAND1 * this.lodScale;
    const R2_FAR = BASE_R2_FAR * this.lodScale;
    const BAND2 = BASE_BAND2 * this.lodScale;
    const EX_R1_FAR = BASE_EX_R1_FAR * this.lodScale;
    const EX_BAND = BASE_EX_BAND * this.lodScale;
    const IMP_CAST_FAR = BASE_IMP_CAST_FAR * this.lodScale;
